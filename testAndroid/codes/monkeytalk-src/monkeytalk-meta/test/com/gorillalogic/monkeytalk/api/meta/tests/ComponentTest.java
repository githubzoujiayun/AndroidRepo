...
public class ComponentTest {
	...
	public void testConstructor() {
		Component c = new Component("Foo", "foo desc", null, null, null, null);
	...
	public void testConstructorWithParent() {
		Component c = new Component("Foo", "foo desc", "Button", null, null, null);
		assertThat(c, notNullValue());
		assertThat(c.getName(), is("Foo"));
		assertThat(c.getDescription(), is("foo desc"));
	...
	public void testConstructorWithNulls() {
		Component c = new Component(null, null, null, null, null, null);
		assertThat(c, notNullValue());
