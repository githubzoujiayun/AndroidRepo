...
#define MTCommandClearCookies @"ClearCookies"
...
#define MTCommandScrollToIndex @"ScrollToIndex"  // Added for collectionView
...
// Main base classes
#define MTObjCComponentsArray [NSArray arrayWithObjects: @"UIButton",@"UITextField",@"UILabel",@"UITextView",@"UITableView",@"UIPickerView",@"UIDatePicker",@"UISegmentedControl",@"UISlider",@"UIScrollView",@"UITabBar",@"UISwitch",@"UIToolbar",@"UICollectionView",nil]