...
@interface MTDDTTYLogger : MTDDAbstractLogger <MTDDLogger>
{
	NSCalendar *calendar;
...
/* Inherited from the MTDDLogger protocol:
 * 
...
/**
 * Similar to the methods above, but allows you to map MTDDLogMessage->tag to a particular color profile.
 * For example, you could do something like this:
 * 
 * static NSString *const PurpleTag = @"PurpleTag";
 * 
 * #define MTDDLogPurple(frmt, ...) LOG_OBJC_TAG_MACRO(NO, 0, 0, 0, PurpleTag, frmt, ##__VA_ARGS__)
 * 
 ...
 * [MTDDLog addLogger:[DDTTYLogger sharedInstance]];
 * 
 * This would essentially give you a straight NSLog replacement that prints in purple:
 * 
 * MTDDLogPurple(@"I'm a purple log message!");
**/
#if TARGET_OS_IPHONE
