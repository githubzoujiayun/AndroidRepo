...
@implementation MTDDASLLogger

static MTDDASLLogger *sharedInstance;
...
+ (void)initialize
{
	...
	if (!initialized)
	{
		...
		sharedInstance = [[MTDDASLLogger alloc] init];
	}
}

+ (MTDDASLLogger *)sharedInstance
{
