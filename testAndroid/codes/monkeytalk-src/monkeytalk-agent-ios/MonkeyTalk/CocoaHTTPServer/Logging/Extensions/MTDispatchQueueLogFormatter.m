#import "MTDispatchQueueLogFormatter.h"
...
@implementation MTDispatchQueueLogFormatter
{
...
- (NSString *)queueThreadLabelForLogMessage:(MTDDLogMessage *)logMessage
{
	// As per the MTDDLogFormatter contract, this method is always invoked on the same thread/dispatch_queue
