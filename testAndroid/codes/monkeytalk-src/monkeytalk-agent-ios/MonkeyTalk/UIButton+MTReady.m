...
+ (NSArray *)aliased {
    if (self == [UIButton class]) {
        return [NSArray arrayWithObjects:@"UINavigationItemButtonView", @"UINavigationButton", @"UIThreePartButton", @"UIRoundedRectButton", @"UIToolbarTextButton", @"UIAlertButton", @"_UIModalItemTableViewCell", @"_UIAlertControllerActionView", nil];
    }
    return nil;
}
