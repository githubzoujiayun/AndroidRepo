...
public class AppAutomatorTest {
	...
	@Test
	public void testPlayReturnNonString() {
		AppAutomator app = new AppAutomator();
		app.setMonkeyID("com.gorillalogic.fonemonkey.automators.tests.Fred");
		assertThat(app.getComponentType(), is(AutomatorConstants.TYPE_APP));

		String val = app.play(AutomatorConstants.ACTION_EXECANDRET, "myvar", "baz", "arg1", "arg2");
		assertThat(val, is("1"));
	}

	@Test
	public void testPlayBadParam() {
		AppAutomator app = new AppAutomator();
		app.setMonkeyID("com.gorillalogic.fonemonkey.automators.tests.Fred");
		assertThat(app.getComponentType(), is(AutomatorConstants.TYPE_APP));
		...
		try {
			...
			assertThat(
					ex.getMessage(),
					is("Method 'buzz' on Class 'com.gorillalogic.fonemonkey.automators.tests.Fred' must take no param or a single varargs String param"));
			return;
		}
		fail("should have thrown exception");
	}
	...
	@Test
	public void testPlayNoParam() {
		AppAutomator app = new AppAutomator();
		app.setMonkeyID("com.gorillalogic.fonemonkey.automators.tests.Fred");
		assertThat(app.getComponentType(), is(AutomatorConstants.TYPE_APP));

		String val = app.play(AutomatorConstants.ACTION_EXECANDRET, "myvar", "noparam");
		assertThat(val, is("noparamreturn"));
	}
}