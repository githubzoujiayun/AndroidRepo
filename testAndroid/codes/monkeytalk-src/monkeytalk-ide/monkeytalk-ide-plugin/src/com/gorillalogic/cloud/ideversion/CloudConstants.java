...
public class CloudConstants {
	public static final String DEFAULT_CONTROLLER_HOST = System
			...
			.getenv("MONKEYTALK_IDE_CLOUD_CONTROLLER_HOST") : "";
	...
	public static final int DEFAULT_CONTROLLER_PUBLIC_PORT = System
			...
			.getenv("MONKEYTALK_IDE_CLOUD_CONTROLLER_PORT")) : 8081;
	...
	public static final String DEFAULT_CONTROLLER_PROTOCOL = (System
			.getenv("MONKEYTALK_IDE_CLOUD_CONTROLLER_PROTOCOL") != null ? System
			.getenv("MONKEYTALK_IDE_CLOUD_CONTROLLER_PROTOCOL") : "https");
