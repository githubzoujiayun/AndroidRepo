...
public class HttpUtils {
	...
	public static void showHttpAuthDiagnostics(String id, HttpClient client, HttpPost post,
	...
	public static String getHttpAuthDiagnostics(String id, HttpClient client, HttpPost post,
			HttpContext localContext) {
		...
		sb.append("==================> HttpClient Diagnostics: ").append(id)
				.append(" <====================\n");

		org.apache.http.auth.AuthState proxyAuthState = (org.apache.http.auth.AuthState) localContext
				.getAttribute(org.apache.http.client.protocol.ClientContext.PROXY_AUTH_STATE);
		...
		org.apache.http.auth.AuthState targetAuthState = (org.apache.http.auth.AuthState) localContext
				.getAttribute(org.apache.http.client.protocol.ClientContext.TARGET_AUTH_STATE);
		...
		sb.append("================> END HttpClient Diagnostics: ").append(id)
				.append(" <==================\n");
		return sb.toString();
	}
			...
			if (proxyHost != null && proxyHost.length() > 0) {
				...
				if (useProxyAuthentication) {
					client.getParams().setParameter(
							...
							true);
					CredentialsProvider credsProvider = ((AbstractHttpClient) client)
