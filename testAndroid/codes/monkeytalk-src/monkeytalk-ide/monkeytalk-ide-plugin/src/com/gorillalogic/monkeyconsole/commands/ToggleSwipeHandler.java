 ...
 */
public class ToggleSwipeHandler extends PreferenceToggleHandler {
	
	private static String PROP_NAME 
			= PreferenceConstants.P_RECORD_SWIPE;
	private static String COMMAND_ID 
			= "com.gorillalogic.monkeyconsole.commands.toggleSwipeCommand";
	
	/**
	 * The constructor.
	 */
	public ToggleSwipeHandler() {
	...
	protected Object doExecute(ExecutionEvent event) throws ExecutionException {
		...
		if (targetState) {
			...
			prefs.setValue(PreferenceConstants.P_RECORD_MOVE, false);
