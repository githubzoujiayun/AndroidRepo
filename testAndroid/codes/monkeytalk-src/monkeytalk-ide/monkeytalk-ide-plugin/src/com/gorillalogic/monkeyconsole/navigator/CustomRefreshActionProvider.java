...
public class CustomRefreshActionProvider extends CommonActionProvider {
    ...
    protected void makeActions() {
        ...
        refreshAction.setDisabledImageDescriptor(MonkeyTalkImagesEnum.REFRESHNAVDISABLED.image);//$NON-NLS-1$
        refreshAction.setImageDescriptor(MonkeyTalkImagesEnum.REFRESHNAVENABLED.image);//$NON-NLS-1$
