 ...
 */
public class ToggleDragHandler extends PreferenceToggleHandler {
	
	private static String PROP_NAME 
			= PreferenceConstants.P_RECORD_DRAG;
	private static String COMMAND_ID 
			= "com.gorillalogic.monkeyconsole.commands.toggleDragCommand";
	
	/**
	 * The constructor.
	 */
	public ToggleDragHandler() {
