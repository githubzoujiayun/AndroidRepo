...
public enum Mods {
	...
	public static class Builder {
		...
		public Builder() {
			mods = new LinkedHashMap<String, String>();
		}
	...
	/** Helper to build a 5-entry modifiers map. */
	public static Map<String, String> of(Mods m1, String v1, Mods m2, String v2, Mods m3,
			String v3, Mods m4, String v4, Mods m5, String v5) {
		Map<String, String> map = new HashMap<String, String>(5);
		map.put(m1.toString(), v1);
		map.put(m2.toString(), v2);
		map.put(m3.toString(), v3);
		map.put(m4.toString(), v4);
		map.put(m5.toString(), v5);
		return map;
	}

	/** Helper to build an arbitrary sized map of string keys and string values. */
	public static Map<String, String> of(String... items) {
		if (items.length == 0) {
		...
		int sz = items.length / 2;
		Map<String, String> map = new HashMap<String, String>(sz);
		for (int i = 0; i < sz; i++) {
			String key = items[i * 2];
			String val = items[i * 2 + 1];
			map.put(key, val);
		}
		return map;
	}
