...
/**
 * Base class for the Component and Action proxy handlers. Does the actual playing of MonkeyTalk
 * commands.
 */
public class Player {
	...
	public Player(ScriptProcessor processor, Scope scope) {
	 ...
	 */
	public String play(Command cmd) {
