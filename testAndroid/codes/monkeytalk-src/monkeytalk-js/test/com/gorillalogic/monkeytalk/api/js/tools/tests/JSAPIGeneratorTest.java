...
public class JSAPIGeneratorTest extends TestHelper {
	...
	@Test
	public void testClassLoaderResource() throws IOException {
	...
	@Test
	public void testGenWithEmptyDir() throws IOException {
		File dir = tempDir();
	...
	@Test
	public void testGenWithMTObject() throws IOException {
		File dir = tempDir();
	...
	@Test
	public void testGenWithMTObjectAndView() throws IOException {
		File dir = tempDir();
		tempScript("MTObject.java", "package com.gorillalogic.monkeytalk.api;\n\n"
				+ "/** MTObject class.\n* @ignoreJS */\n" + "public interface MTObject {\n"
				+ "public Application getApp();\n" + "public String getComponentType();\n"
	...
	@Test
	public void testGenWithViewAndButton() throws IOException {
		File dir = tempDir();
		tempScript("View.java", "package com.gorillalogic.monkeytalk.api;\n\n"
				+ "/** View class */\n" + "public interface View extends MTObject {\n"
				+ "/** Do tap. */\n" + "public void tap();\n" + "}\n", dir);
	...
	@Test
	public void testGenWithLongJavadocDescription() throws IOException {
		File dir = tempDir();
		tempScript("View.java", "package com.gorillalogic.monkeytalk.api;\n\n"
				+ "/** View class */\n" + "public interface View extends MTObject {\n"
				+ "/** Do tap. */\n" + "public void tap();\n" + "}\n", dir);
		tempScript(
				...
				"package com.gorillalogic.monkeytalk.api;\n"
						+ "\n"
						+ "/**\n"
						+ " * A Button. iOS: UIButton. Android: Button. Web: Button tag, or Input tag with type=\"submit\" or\n"
						+ " * type=\"reset\". If\n"
		...
		assertThat(
				js,
				containsString(" * A Button. iOS: UIButton. Android: Button. Web: Button tag, or Input tag with type='submit' or type='reset'. If the button has a label, it is used as the monkeyId."));
		assertThat(js, not(containsString("$")));
	}
