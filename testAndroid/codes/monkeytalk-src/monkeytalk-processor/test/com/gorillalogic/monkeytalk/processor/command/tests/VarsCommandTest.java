...
public class VarsCommandTest extends BaseCommandHelper {
	...
	@Test
	public void testVerifyRedefine() throws IOException {
		File dir = tempDir();
		tempScript("foo.mt", "Vars * Define foo=abc\nVars * Define foo=def\n"
				+ "Vars * Verify abc foo", dir);
		...
		assertThat(output, containsString("START"));
		assertThat(output, containsString("Vars * Define foo=abc -> OK"));
		assertThat(output, containsString("Vars * Define foo=def -> OK"));
		assertThat(output, containsString("Vars * Verify abc foo -> OK"));
		assertThat(output, containsString("COMPLETE : OK"));
	}
