...
public class GlobalsRunnerTest extends TestHelper {
	...
	@Test
	public void testScriptWithLocalOverrideOfExistingGlobalVar() throws IOException {
		File dir = tempDir();
		...
		assertThat(server.getCommands().get(1).getCommand(), is("Button abc Tap"));

		assertThat(out.toString(), containsString("START"));
		assertThat(out.toString(), containsString("Button 123 Tap -> OK\n"));
		assertThat(out.toString(), containsString("Vars * Define foo=abc -> OK\n"));
		assertThat(out.toString(), containsString("Button abc Tap -> OK\n"));
		assertThat(out.toString(), containsString("COMPLETE : OK\n"));
	...
	@Test
	public void testScriptWithLocalOverrideOfNewGlobalVar() throws IOException {
		File dir = tempDir();
		...
		assertThat(out.toString(), containsString("START"));
		assertThat(out.toString(), containsString("Globals * Set foo=123 -> OK\n"));
		assertThat(out.toString(), containsString("Button 123 Tap -> OK\n"));
		assertThat(out.toString(), containsString("Vars * Define foo=abc -> OK\n"));
		assertThat(out.toString(), containsString("Button abc Tap -> OK\n"));
		assertThat(out.toString(), containsString("COMPLETE : OK\n"));
	...
	@Test
	public void testScriptWithGlobalOverrideOfLocalVar() throws IOException {
		File dir = tempDir();
		tempScript("foo.mt",
				"Vars * Define foo=abc bar baz fred\nButton ${foo} Tap ${bar}-${baz}-${fred}", dir);

		Globals.setGlobal("foo", "123");
		Globals.setGlobal("bar", "BAR");
		Globals.setGlobal("baz", "456");
		...
		assertThat("FAIL: " + result, result.getStatus(), is(PlaybackStatus.OK));
		assertThat(result.getSteps().size(), is(2));
		assertThat(
				result.getSteps().get(0).getResult().getWarning(),
				is("using global value 'BAR' for variable 'bar', using global value '456' for variable 'baz'"));
		assertThat(result.getSteps().get(1).getResult().getWarning(), nullValue());

		assertThat(server.getCommands(), notNullValue());
		assertThat(server.getCommands().size(), is(1));
		assertThat(server.getCommands().get(0).getCommand(), is("Button abc Tap BAR-456-<fred>"));

		assertThat(out.toString(), containsString("START"));
		assertThat(out.toString(), containsString("Vars * Define foo=abc bar baz fred -> OK\n"));
		assertThat(out.toString(), containsString("Button abc Tap BAR-456-<fred> -> OK\n"));
		assertThat(out.toString(), containsString("COMPLETE : OK\n"));
	}

	@Test
	public void testScriptRunWithWithoutGlobalOverrideOfLocalVar() throws IOException {
		File dir = tempDir();
		tempScript("foo.mt", "Vars * Define foo bar\nButton ${foo} Tap ${bar}", dir);
		tempScript("bar.mt", "Script foo.mt RunWith data.csv", dir);
		tempScript("data.csv", "foo\n222\n333", dir);

		Globals.setGlobal("foo", "FOO");
		Globals.setGlobal("bar", "BAR");
		...
		assertThat(server.getCommands(), notNullValue());
		assertThat(server.getCommands().size(), is(2));
		assertThat(server.getCommands().get(0).getCommand(), is("Button 222 Tap BAR"));
		assertThat(server.getCommands().get(1).getCommand(), is("Button 333 Tap BAR"));

		// foo gets data-driven, but bar get global override
		assertThat(out.toString(), containsString("START"));
		assertThat(out.toString(), containsString("Script foo.mt RunWith data.csv"));
		assertThat(
				out.toString(),
				containsString("START\nVars * Define foo bar -> OK\nButton 222 Tap BAR -> OK\nCOMPLETE : OK\n"));
		assertThat(
				out.toString(),
				containsString("START\nVars * Define foo bar -> OK\nButton 333 Tap BAR -> OK\nCOMPLETE : OK\n"));
		assertThat(out.toString(), containsString("COMPLETE : OK : 2 data records processed\n"));
	}
	...
	public void testRunner() throws IOException {
		...
		assertThat(out.toString(), not(containsString("loading globals.properties")));
		assertThat(out.toString(), containsString("loading globals: foo, bar"));
		assertThat(out.toString(), containsString("Button 123 Tap \"Bo Bo\" -> OK\n"));
	}
	...
	public void testRunnerGetIntoGlobal() throws IOException {
		...
		assertThat(out.toString(), containsString("www.cloudmonkeymobile.com"));
		assertThat(out.toString(), not(containsString("loading globals.properties")));
		assertThat(out.toString(), containsString("loading globals: foo"));
	...
	@Test
	public void testRunnerSystemExecIntoGlobal() throws IOException {
		File dir = tempDir();
		File foo = tempScript("foo.mt", "System * ExecAndReturn foo echo foobar", dir);
		...
		assertThat(out.toString(),
				containsString("System * ExecAndReturn foo echo foobar -> OK : foobar\n"));
		assertThat(out.toString(), containsString("result: OK\n"));

		assertThat(Globals.getGlobals().size(), is(1));
		assertThat(Globals.getGlobal("foo"), is("foobar"));
		assertThat(Globals.getGlobal("bar"), nullValue());
	}

	@Test
	public void testRunnerSystemExecIntoLocalOverrideOfGlobal() throws IOException {
		File dir = tempDir();
		File foo = tempScript(
				"foo.mt",
				"Button ${foo} Tap\nVars * Set foo=234\nButton ${foo} Tap\nSystem * ExecAndReturn foo echo foobar\nButton ${foo} Tap",
				dir);
		...
		assertThat(server.getCommands().size(), is(3));
		assertThat(server.getCommands().get(0).getCommand(), is("Button 123 Tap"));
		assertThat(server.getCommands().get(1).getCommand(), is("Button 234 Tap"));
		assertThat(server.getCommands().get(2).getCommand(), is("Button foobar Tap"));

		assertThat(out.toString(), containsString("www.cloudmonkeymobile.com"));
		assertThat(out.toString(), not(containsString("loading globals.properties")));
		assertThat(out.toString(), containsString("loading globals: foo"));
		assertThat(out.toString(), containsString("Button 123 Tap -> OK\n"));
		assertThat(out.toString(), containsString("Vars * Set foo=234 -> OK\n"));
		assertThat(out.toString(), containsString("Button 234 Tap -> OK\n"));
		assertThat(out.toString(),
				containsString("System * ExecAndReturn foo echo foobar -> OK : foobar\n"));
		assertThat(out.toString(), containsString("Button foobar Tap -> OK\n"));
		assertThat(out.toString(), containsString("result: OK\n"));
	...
	@Test
	public void testRunnerMTCallsMTCallsMT() throws IOException {
		File dir = tempDir();
		File foo = tempScript("foo.mt", "Button 1FOO${foo} Tap\n" + "Globals * Set foo=234\n"
				+ "Script bar.mt Run\nButton 2FOO${foo} Tap", dir);

		tempScript("bar.mt", "Button 1BAR${foo} Tap\n" + "Globals * Set foo=345\n"
				+ "Script baz.mt Run\nButton 2BAR${foo} Tap", dir);
		...
		assertThat(cmds.get(0).getCommand(), is("Button 1FOO123 Tap"));
		assertThat(cmds.get(1).getCommand(), is("Button 1BAR234 Tap"));
		assertThat(cmds.get(2).getCommand(), is("Button 1BAZ345 Tap"));
		assertThat(cmds.get(3).getCommand(), is("Button 2BAZ456 Tap"));
		assertThat(cmds.get(4).getCommand(), is("Button 2BAR456 Tap"));
		assertThat(cmds.get(5).getCommand(), is("Button 2FOO456 Tap"));

		String o = out.toString();
		assertThat(o, containsString("www.cloudmonkeymobile.com"));
		assertThat(o, not(containsString("loading globals.properties")));
		assertThat(o, containsString("loading globals: foo"));
		assertThat(o, containsString("Button 1FOO123 Tap -> OK\n"));
		assertThat(o, containsString("Globals * Set foo=234 -> OK\n"));
		assertThat(o, containsString("Script bar.mt Run\n"));
		assertThat(o, containsString("Button 1BAR234 Tap -> OK\n"));
		assertThat(o, containsString("Globals * Set foo=345 -> OK\n"));
		assertThat(o, containsString("Script baz.mt Run\n"));
		assertThat(o, containsString("Button 1BAZ345 Tap -> OK\n"));
		assertThat(o, containsString("Globals * Set foo=456 -> OK\n"));
		assertThat(o, containsString("Button 2BAZ456 Tap -> OK\n"));
		assertThat(o, containsString("Button 2BAR456 Tap -> OK\n"));
		assertThat(o, containsString("Button 2FOO456 Tap -> OK\n"));
	...
	public void testRunnerJSCallsMTCallsJS() throws IOException {
		...
		assertThat(o, containsString("www.cloudmonkeymobile.com"));
		assertThat(o, not(containsString("loading globals.properties")));
		assertThat(o, containsString("loading globals: foo, bar"));
