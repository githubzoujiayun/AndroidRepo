...
public class ScriptProcessorTest extends TestHelper {
	...
	@Test
	public void testRunScriptWithSingleScriptWithDatafileWithoutVarsDefine() throws Exception {
		File dir = tempDir();
		File data = tempScript("data.csv", "first,last\nJoe,Smith\n\"Bo Bo\",Baker\n", dir);
		File foo = tempScript("foo.mt", "Input firstName EnterText ${first}\n"
				+ "Input lastName EnterText ${last}", dir);
		Command cmd = new Command("Script foo.mt RunWith data.csv");
	...
	@Test
	public void testRunScriptWithWaitFor() throws Exception {
		File dir = tempDir();
		...
		assertThat(output, containsString("Button FOO WaitFor -> OK\n"));
