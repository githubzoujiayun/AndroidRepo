...
public class CommandValidationTest extends BaseCommandTest {
	...
	public void testConstructorWithType() {
		CommandValidator v = new CommandValidator(CommandStatus.BAD_COMPONENT_TYPE);
	...
	public void testConstructorWithTypeAndMessage() {
		CommandValidator v = new CommandValidator(CommandStatus.BAD_MONKEY_ID, "some message");
	...
	public void testConstructorWithTypeAndNullMessage() {
		CommandValidator v = new CommandValidator(CommandStatus.BAD_ACTION, null);
	...
	public void testNullComponentTypeIsInvalid() {
		...
		assertThat(v.toString(), is("Bad componentType : componentType is empty"));
	}
	...
	public void testNullMonkeyIdIsInvalid() {
		...
		assertThat(v.toString(), is("Bad monkeyId : monkeyId is empty"));
	}
	...
	@Test
	public void testUnknownModifiersIsInvalid() {
		Map<String, String> mods = new HashMap<String, String>();
		mods.put("badmodifier", "true");
		Command cmd = new Command("Button", "OK", "Tap", null, mods);
		CommandValidator v = CommandValidator.validate(cmd);
		assertThat(cmd.isValid(), is(false));
		assertThat(v.getStatus(), is(CommandStatus.BAD_MODIFIERS));
		assertThat(v.getMessage(), is("unknown modifier \"badmodifier\""));
		assertThat(v.toString(), is("Bad modifiers : unknown modifier \"badmodifier\""));
	}

	@Test
	public void testGoodModifiers() {
		Map<String, String> mods = new HashMap<String, String>();
		mods.put(Command.IGNORE_MODIFIER, "true");
		mods.put(Command.SCREENSHOT_ON_ERROR, "false");
		mods.put(Command.SHOULD_FAIL_MODIFIER, "false");
		mods.put(Command.TIMEOUT_MODIFIER, "1000");
		mods.put(Command.THINKTIME_MODIFIER, "2000");
		mods.put(Command.RETRY_DELAY_MODIFIER, "100");
		Command cmd = new Command("Button", "OK", "Tap", null, mods);
		assertThat(cmd.isValid(), is(true));
	}
}