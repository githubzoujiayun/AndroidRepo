...
public class GlobalsRunnerIT extends BaseHelper {
	...
	public void testCommandlineGlobals() throws Exception {
		...
		assertThat(run, containsString("www.cloudmonkeymobile.com"));
		assertThat(run, not(containsString("loading globals.properties")));
		assertThat(run, containsString("loading globals: foo, bar"));
	...
	public void testCommandlineGlobalsOverridePropertiesFile() throws Exception {
		...
		assertThat(run, containsString("www.cloudmonkeymobile.com"));
		assertThat(run, containsString("loading globals.properties"));
		assertThat(run, containsString("loading globals: foo"));
