...
public class RunnerTest extends BaseHelper {
	...
	public void testScript() throws IOException {
		...
		assertThat(output.toString(), containsString("MonkeyTalk v"));
		assertThat(output.toString(), containsString("www.cloudmonkeymobile.com"));
	...
	public void testWithNullArgs() {
		...
		assertThat(output.toString(), containsString("MonkeyTalk v"));
		assertThat(output.toString(), containsString("www.cloudmonkeymobile.com"));
		assertThat(output.toString(), containsString("ERROR: Bad commandline args"));
	...
	public void testMetrics() throws IOException {
		...
		assertThat(server.getCommands().size(), is(2));
		assertThat(server.getCommands().get(0).getCommand(), is("Button OK Click"));
		assertThat(server.getCommands().get(1).getCommand(), is("Device * Get dummy allinfo"));
