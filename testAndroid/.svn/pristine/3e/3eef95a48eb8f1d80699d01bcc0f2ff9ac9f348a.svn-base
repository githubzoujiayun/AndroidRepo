...
import com.gorillalogic.monkeytalk.processor.report.detail.DetailReportHtmlFactory;
...
public class DetailReportHtmlTest extends TestHelper {
	...
	public void testSimpleScript() throws Exception {
		...
		String html = createDetailReportHtml().createDetailReportHtml(result, xml);
	...
	private DetailReportHtml createDetailReportHtml() {
