#import "MTContextFilterLogFormatter.h"
...
@interface MTLoggingContextSet : NSObject
...
@implementation MTContextWhitelistFilterLogFormatter
{
	MTLoggingContextSet *contextSet;
}
...
- (id)init
{
	if ((self = [super init]))
	{
		contextSet = [[MTLoggingContextSet alloc] init];
	}
	return self;
}
...
@implementation MTContextBlacklistFilterLogFormatter
{
	MTLoggingContextSet *contextSet;
}
...
@implementation MTLoggingContextSet
{
	OSSpinLock lock;
	NSMutableSet *set;
}
