...
+ (NSDictionary *) componentsDictionary {
    ...
    [mutableComponents setValue:@"UICollectionView" forKey:[MTComponentGrid lowercaseString]];
...
+ (NSDictionary *) recordDictionary {
    ...
    [mutableComponents setValue:MTComponentButton forKey:@"_UIAlertControllerActionView"];
    ...
    [mutableComponents setValue:MTComponentGrid forKey:@"UICollectionView"];
