...
- (id)initWithRequest:(MTHTTPMessage *)request socket:(MTGCDAsyncSocket *)socket;
...
- (void)webSocketDidOpen:(MTWebSocket *)ws;

- (void)webSocket:(MTWebSocket *)ws didReceiveMessage:(NSString *)msg;

- (void)webSocketDidClose:(MTWebSocket *)ws;
