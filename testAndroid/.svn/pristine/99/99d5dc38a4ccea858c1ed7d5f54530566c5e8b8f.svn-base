...
public class CommandWorldTest {
	...
	public void testConstructorWithDir() {
		...
		assertThat(world.toString(), containsString("foozip.mt"));
		assertThat(world.toString(), containsString("barzip.mt"));
	}
	...
	public void testGetZip() {
		...
		assertThat(world.toString(), containsString("foozip.mt"));
		assertThat(world.toString(), containsString("barzip.mt"));
		assertNotNull(world.getScript("foozip.mt"));
		assertNotNull(world.getScript("barzip.mt"));
		assertNotNull(world.getSuite("suitezip.mts"));
		assertNotNull(world.getData("nameszip.csv"));
		assertNotNull(world.getScript("compzip.action.mt"));
		assertNotNull(world.getScript("compzip.foobar.mt"));
		assertTrue(world.hasJavascriptOverride("foozip.js"));
		assertTrue(world.hasJavascriptOverride("foozip"));
	}
