#import "MTDDAbstractDatabaseLogger.h"
#import <math.h>
...
@interface MTDDAbstractDatabaseLogger ()
...
@implementation MTDDAbstractDatabaseLogger
...
- (BOOL)db_log:(MTDDLogMessage *)logMessage
{
...
- (void)flush
{
	// This method is invoked by MTDDLog's flushLog method.
	// 
	// It is called automatically when the application quits,
	// or if the developer invokes MTDDLog's flushLog method prior to crashing or something.
