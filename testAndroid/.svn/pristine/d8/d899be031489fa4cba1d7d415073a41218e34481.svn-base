...
public class Runner {
	...
	public static void main(String[] args) {
		...
		if (runner != null) {
			try {
				...
				runner.setTakeAfterMetrics(parser.metrics);
				...
				// print version, error message, usage, and exit
				System.out.println(BuildStamp.getStamp());
				System.out.println("\nERROR: " + ex.getMessage() + "\n");
				parser.printUsage();
			} finally {
	...
	private static class CommandlineParser {
		...
		@Parameter(names = "-metrics", description = "Record system usage metrics after every command")
