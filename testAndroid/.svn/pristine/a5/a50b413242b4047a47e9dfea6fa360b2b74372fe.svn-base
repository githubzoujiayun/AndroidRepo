...
public class JavascriptTest extends TestHelper {
	...
	public void testRunJavascript() throws IOException {
		...
		assertThat(log, containsString("www.cloudmonkeymobile.com"));
	...
	@Test
	public void testRunJavascriptWithFailure() throws IOException {
		File dir = tempDir();
		File foo = tempScript("foo.mt", "Button FOO Tap\nButton FRED Tap\nButton BAR Tap", dir);
		File fooJS = new File(dir, "foo.js");
		...
		assertThat(js, containsString("MyProj.foo.prototype.run = function() {\n"));
		assertThat(js, containsString("app.button(\"FOO\").tap();\n"));
		assertThat(js, containsString("app.button(\"FRED\").tap();\n"));
		assertThat(js, containsString("app.button(\"BAR\").tap();\n"));
		...
		assertThat(log, containsString("result: FAILURE : fail on Fred"));
	}

	@Test
	public void testRunJavascriptWithShouldFailModifier() throws IOException {
		File dir = tempDir();
		File foo = tempScript("foo.mt",
		...
		assertThat(js, containsString("MyProj.foo.prototype.run = function() {\n"));
		assertThat(js, containsString("app.button(\"FOO\").tap();\n"));
		assertThat(js, containsString("app.button(\"FRED\").tap({shouldfail:\"true\"});\n"));
		assertThat(js, containsString("app.button(\"BAR\").tap();\n"));
		...
		assertThat(log, containsString("www.cloudmonkeymobile.com"));
		assertThat(log, containsString("Button FOO tap -> OK"));
		assertThat(log, containsString("Button FRED tap %shouldfail=true -> OK"
				+ " : expected failure : fail on Fred"));
		assertThat(log, containsString("Button BAR tap -> OK"));
		assertThat(log, containsString("result: OK"));
	}

	@Test
	public void testRunJavascriptWithIgnoreModifier() throws IOException {
		File dir = tempDir();
		File foo = tempScript("foo.mt",
				"Button FOO Tap\nButton FRED Tap %ignore=true\nButton BAR Tap", dir);
		File fooJS = new File(dir, "foo.js");
		...
		assertThat(js, containsString("MyProj.foo.prototype.run = function() {\n"));
		assertThat(js, containsString("app.button(\"FOO\").tap();\n"));
		assertThat(js, containsString("app.button(\"FRED\").tap({ignore:\"true\"});\n"));
		assertThat(js, containsString("app.button(\"BAR\").tap();\n"));
		...
		assertThat(log, containsString("www.cloudmonkeymobile.com"));
		assertThat(log, containsString("Button FOO tap -> OK"));
		assertThat(log, containsString("Button FRED tap %ignore=true -> OK : ignored"));
		assertThat(log, containsString("Button BAR tap -> OK"));
		assertThat(log, containsString("result: OK"));
	}
	...
	public void testRunJavascriptWithGlobals() throws IOException {
		...
		assertThat(Globals.getGlobal("missing"), nullValue());
	}
	...
	@Test
	public void testRunJavascriptWithGlobalsJSCallingJS() throws IOException {
		assertThat(Globals.getGlobals().size(), is(0));

		File dir = tempDir();
		File foo = tempScript("foo.mt", "Globals * Set foo=123\nButton FOO-${foo} Tap\n"
				+ "Script bar.js Run\nButton FOO-${foo}-${bar} Tap", dir);
		File bar = tempScript("bar.mt",
				"Globals * Set bar=456\nButton BAR-${foo} Tap\nButton BAR-${bar} Tap", dir);
		File fooJS = new File(dir, "foo.js");
		...
		assertThat(js, containsString("app.globals().set('foo=\"123\"');"));
		assertThat(js, containsString("foo = '123';"));
		assertThat(js, containsString("app.button(\"FOO-\" + foo).tap();"));
		assertThat(js, containsString("app.script(\"bar.js\").run();"));
		assertThat(js, containsString("app.button(\"FOO-\" + foo + \"-\" + bar).tap();"));

		js = FileUtils.readFile(barJS);
		assertThat(js, containsString("load(\"libs/MyProj.js\");"));
		assertThat(js, containsString("MyProj.bar.prototype.run = function() {"));
		assertThat(js, containsString("var app = this.app;\n"));
		assertThat(js, containsString("app.globals().set('bar=\"456\"');"));
		assertThat(js, containsString("bar = '456';"));
		assertThat(js, containsString("app.button(\"BAR-\" + foo).tap();"));
		assertThat(js, containsString("app.button(\"BAR-\" + bar).tap();"));
		...
		assertThat(server.getCommands().get(0).getCommand(), is("Button FOO-123 tap"));
		assertThat(server.getCommands().get(1).getCommand(), is("Button BAR-123 tap"));
		assertThat(server.getCommands().get(2).getCommand(), is("Button BAR-456 tap"));
		assertThat(server.getCommands().get(3).getCommand(), is("Button FOO-123-456 tap"));

		String log = FileUtils.readFile(logger);
		assertThat(log, containsString("www.cloudmonkeymobile.com"));
		assertThat(log, containsString("Globals * set foo=\"123\" -> OK\n"));
		assertThat(log, containsString("Button FOO-123 tap -> OK\n"));
		assertThat(log, containsString("Script bar.js Run\n"));
		assertThat(log, containsString("Globals * set bar=\"456\" -> OK\n"));
		assertThat(log, containsString("Button BAR-123 tap -> OK\n"));
		assertThat(log, containsString("Button BAR-456 tap -> OK\n"));
		assertThat(log, containsString("Button FOO-123-456 tap -> OK\n"));
		assertThat(log, containsString("result: OK"));
	...
	@Test
	public void testRunJavascriptWithGlobalsJSCallingJSCallingJS() throws IOException {
		assertThat(Globals.getGlobals().size(), is(0));

		File dir = tempDir();
		File foo = tempScript("foo.mt", "Globals * Set foo=123\nButton FOO-${foo} Tap\n"
				+ "Script bar.js Run\nButton FOO-${foo}-${bar}-${baz} Tap", dir);
		File bar = tempScript("bar.mt",
				"Globals * Set bar=456\nButton BAR-${foo} Tap\nButton BAR-${bar} Tap\n"
						+ "Script baz.js Run\nButton BAR-${bar}-${baz} Tap", dir);
		File baz = tempScript(
				"baz.mt",
				"Globals * Set baz=789\nButton BAZ-${foo} Tap\nButton BAZ-${bar} Tap\nButton BAZ-${baz} Tap",
				dir);
		File fooJS = new File(dir, "foo.js");
		File barJS = new File(dir, "bar.js");
		File bazJS = new File(dir, "baz.js");
		...
		assertThat(js, containsString("app.script(\"bar.js\").run();"));
		assertThat(js,
				containsString("app.button(\"FOO-\" + foo + \"-\" + bar + \"-\" + baz).tap();"));
		...
		assertThat(js, containsString("app.button(\"BAR-\" + foo).tap();"));
		assertThat(js, containsString("app.button(\"BAR-\" + bar).tap();"));
		assertThat(js, containsString("app.script(\"baz.js\").run();"));
		assertThat(js, containsString("app.button(\"BAR-\" + bar + \"-\" + baz).tap();"));

		js = FileUtils.readFile(bazJS);
		assertThat(js, containsString("load(\"libs/MyProj.js\");"));
		assertThat(js, containsString("MyProj.baz.prototype.run = function() {"));
		assertThat(js, containsString("var app = this.app;\n"));
		assertThat(js, containsString("app.globals().set('baz=\"789\"');"));
		assertThat(js, containsString("baz = '789';"));
		assertThat(js, containsString("app.button(\"BAZ-\" + foo).tap();"));
		assertThat(js, containsString("app.button(\"BAZ-\" + bar).tap();"));
		assertThat(js, containsString("app.button(\"BAZ-\" + baz).tap();"));
		...
		assertThat(server.getCommands().get(1).getCommand(), is("Button BAR-123 tap"));
		assertThat(server.getCommands().get(2).getCommand(), is("Button BAR-456 tap"));
		assertThat(server.getCommands().get(3).getCommand(), is("Button BAZ-123 tap"));
		assertThat(server.getCommands().get(4).getCommand(), is("Button BAZ-456 tap"));
		assertThat(server.getCommands().get(5).getCommand(), is("Button BAZ-789 tap"));
		assertThat(server.getCommands().get(6).getCommand(), is("Button BAR-456-789 tap"));
		assertThat(server.getCommands().get(7).getCommand(), is("Button FOO-123-456-789 tap"));
		...
		assertThat(log, containsString("Globals * set baz=\"789\" -> OK\n"));
		assertThat(log, containsString("Button BAZ-123 tap -> OK\n"));
		assertThat(log, containsString("Button BAZ-456 tap -> OK\n"));
		assertThat(log, containsString("Button BAZ-789 tap -> OK\n"));

		assertThat(log, containsString("Button BAR-456-789 tap -> OK\n"));

		assertThat(log, containsString("Button FOO-123-456-789 tap -> OK\n"));
		assertThat(log, containsString("result: OK"));

		assertThat(Globals.getGlobals().size(), is(3));
		assertThat(Globals.getGlobal("foo"), is("123"));
		assertThat(Globals.getGlobal("bar"), is("456"));
		assertThat(Globals.getGlobal("baz"), is("789"));
	}

	@Test
	public void testRunJavascriptWithGlobalsMTCallingJS() throws IOException {
		assertThat(Globals.getGlobals().size(), is(0));
		...
		String js = FileUtils.readFile(barJS);
		assertThat(js, containsString("load(\"libs/MyProj.js\");"));
		assertThat(js, containsString("MyProj.bar.prototype.run = function() {"));
		assertThat(js, containsString("var app = this.app;\n"));
		assertThat(js, containsString("app.globals().set('bar=\"456\"');"));
	...
	@Test
	public void testRunJavascriptWithGlobalsMTCallingJSCallingJS() throws IOException {
		assertThat(Globals.getGlobals().size(), is(0));
	...
	@Ignore("this test should PASS, but it does not -- see DE601")
	@Test
	public void testRunJavascriptWithGlobalsJSCallingMT() throws IOException {
		assertThat(Globals.getGlobals().size(), is(0));

		File dir = tempDir();
		File foo = tempScript("foo.mt", "Globals * Set foo=123\nButton FOO-${foo} Tap\n"
				+ "Script bar.mt Run\nButton FOO-${foo}-${bar} Tap", dir);
		tempScript("bar.mt", "Globals * Set bar=456\nButton BAR-${foo} Tap\nButton BAR-${bar} Tap",
				dir);
		File fooJS = new File(dir, "foo.js");
		...
		assertThat(js, containsString("foo = '123';"));
		assertThat(js, containsString("app.button(\"FOO-\" + foo).tap();"));
		assertThat(js, containsString("app.bar().run();"));
		assertThat(js, containsString("app.button(\"FOO-\" + foo + \"-\" + bar).tap();"));
	...
	@Test
	public void testRunJavascriptWithRegexEscaping() throws IOException {
		File dir = tempDir();
		File foo = tempScript("foo.mt", "Button FOO Tap\nLabel * VerifyRegex .*\\..*\n"
				+ "Label * VerifyNotRegex \\Afoo\\Z\nButton BAR Tap", dir);
		File fooJS = new File(dir, "foo.js");
		...
		assertThat(js, containsString("MyProj.foo.prototype.run = function() {\n"));
		assertThat(js, containsString("app.button(\"FOO\").tap();\n"));
		assertThat(js, containsString("app.label().verifyRegex(\".*\\\\..*\");\n"));
		assertThat(js, containsString("app.label().verifyNotRegex(\"\\\\Afoo\\\\Z\");\n"));
		assertThat(js, containsString("app.button(\"BAR\").tap();\n"));
		...
		CommandServer server = new VerifyServer(PORT);
		PlaybackResult result = runner.run(fooJS, null);
		server.stop();
		...
		assertThat(server.getCommands().size(), is(4));
		assertThat(server.getCommands().get(0).getCommand(), is("Button FOO tap"));
		assertThat(server.getCommands().get(1).getCommand(), is("Label * verifyRegex .*\\..*"));
		assertThat(server.getCommands().get(2).getCommand(), is("Label * verifyNotRegex \\Afoo\\Z"));
		assertThat(server.getCommands().get(3).getCommand(), is("Button BAR tap"));

		String log = FileUtils.readFile(logger);
		assertThat(log, containsString("www.cloudmonkeymobile.com"));
		assertThat(log, containsString("Button FOO tap -> OK"));
		assertThat(log, containsString("Label * verifyRegex .*\\..* -> OK"));
		assertThat(log, containsString("Label * verifyNotRegex \\Afoo\\Z -> OK"));
		assertThat(log, containsString("Button BAR tap -> OK"));
		assertThat(log, containsString("result: OK"));
	}

	@Test
	public void testRunJavascriptWithVarsVerifyRegexEscaping() throws IOException {
		File dir = tempDir();
		File foo = tempScript("foo.mt", "Vars * Define x=a.b\nVars * VerifyRegex .*\\..* x", dir);
		File fooJS = new File(dir, "foo.js");
		...
		assertThat(js, containsString("load(\"libs/MyProj.js\");\n"));
		assertThat(js, containsString("MyProj.foo.prototype.run = function(x) {\n"));
		assertThat(js, containsString("x = (x != undefined && x != \"*\" ? x : \"a.b\");\n"));
		assertThat(js, containsString("// NOT SUPPORTED YET: app.vars().verify("));
	...
	private class VerifyServer extends FailOnFredServer {
		...
		public Response serve(String uri, String method, Map<String, String> headers,
			...
			if (json.toString().toLowerCase().contains("verifyregex")) {
