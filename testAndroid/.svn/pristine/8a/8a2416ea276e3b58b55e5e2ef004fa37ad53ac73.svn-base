...
#import "MTHTTPAsyncFileResponse.h"
...
- (id)initWithAsyncSocket:(MTGCDAsyncSocket *)newSocket configuration:(MTHTTPConfig *)aConfig
{
	if ((self = [super init]))
	{
		...
		request = [[MTHTTPMessage alloc] initEmptyRequest];
...
- (BOOL)isAuthenticated
{
	...
	MTHTTPAuthenticationRequest *auth = [[MTHTTPAuthenticationRequest alloc] initWithRequest:request];
...
**/
- (void)addDigestAuthChallenge:(MTHTTPMessage *)response
{
	HTTPLogTrace();
...
**/
- (void)addBasicAuthChallenge:(MTHTTPMessage *)response
{
	HTTPLogTrace();
...
- (void)startReadingRequest
{
	...
	[asyncSocket readDataToData:[MTGCDAsyncSocket CRLFData]
...
- (void)replyToHTTPRequest
{
	...
	if ([MTWebSocket isWebSocketRequest:request])
	{
		HTTPLogVerbose(@"isWebSocket");
		
		MTWebSocket *ws = [self webSocketForURI:uri];
...
**/
- (MTHTTPMessage *)newUniRangeResponse:(UInt64)contentLength
{
	HTTPLogTrace();
	
	// Status Code 206 - Partial Content
	MTHTTPMessage *response = [[MTHTTPMessage alloc] initResponseWithStatusCode:206 description:nil version:HTTPVersion1_1];
 ...
 * Note: The returned HTTPMessage is owned by the sender, who is responsible for releasing it.
**/
- (MTHTTPMessage *)newMultiRangeResponse:(UInt64)contentLength
{
	HTTPLogTrace();
...
- (void)sendResponseHeadersAndBody
{
	...
	if (!isRangeRequest)
	{
		...
		response = [[MTHTTPMessage alloc] initResponseWithStatusCode:status description:nil version:HTTPVersion1_1];
		...
		if (!isRangeRequest)
		{
			...
			if ([data length] > 0)
			{
				...
				if (isChunked)
				{
					...
					{
						NSData *footer = [MTGCDAsyncSocket CRLFData];
...
- (NSObject<MTHTTPResponse> *)httpResponseForMethod:(NSString *)method URI:(NSString *)path
{
	...
	{
		return [[MTHTTPFileResponse alloc] initWithFilePath:filePath forConnection:self];
...
- (void)handleVersionNotSupported:(NSString *)version
{
	...
	MTHTTPMessage *response = [[MTHTTPMessage alloc] initResponseWithStatusCode:505 description:nil version:HTTPVersion1_1];
...
- (void)handleAuthenticationFailed
{
	...
	MTHTTPMessage *response = [[MTHTTPMessage alloc] initResponseWithStatusCode:401 description:nil version:HTTPVersion1_1];
	[response setHeaderField:@"Content-Length" value:@"0"];
...
- (void)handleInvalidRequest:(NSData *)data
{
	...
	MTHTTPMessage *response = [[MTHTTPMessage alloc] initResponseWithStatusCode:400 description:nil version:HTTPVersion1_1];
	[response setHeaderField:@"Content-Length" value:@"0"];
...
- (void)handleUnknownMethod:(NSString *)method
{
	...
	MTHTTPMessage *response = [[MTHTTPMessage alloc] initResponseWithStatusCode:405 description:nil version:HTTPVersion1_1];
	[response setHeaderField:@"Content-Length" value:@"0"];
	[response setHeaderField:@"Connection" value:@"close"];
...
- (void)handleResourceNotFound
{
	...
	MTHTTPMessage *response = [[MTHTTPMessage alloc] initResponseWithStatusCode:404 description:nil version:HTTPVersion1_1];
	[response setHeaderField:@"Content-Length" value:@"0"];
...
- (void)socket:(MTGCDAsyncSocket *)sock didReadData:(NSData*)data withTag:(long)tag
{
	...
	else
	{
		...
		else if (tag == HTTP_REQUEST_CHUNK_TRAILER)
		{
			...
			if (![data isEqualToData:[MTGCDAsyncSocket CRLFData]])
			{
...
- (id)initWithServer:(MTHTTPServer *)aServer documentRoot:(NSString *)aDocumentRoot
{
	if ((self = [super init]))
	{
		server = aServer;
...
- (id)initWithServer:(MTHTTPServer *)aServer documentRoot:(NSString *)aDocumentRoot queue:(dispatch_queue_t)q
{
	if ((self = [super init]))
	{
		server = aServer;
