...
public interface Table {
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void scrollToIndex(Map<String, String> mods);
	/**
	 * Scroll to a row by index.
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void scrollToIndex(int index, Map<String, String> mods);
	...
	/**
	 * Taps on the component. On Android, plays a 'click'. On iOS, plays a TouchDown/TouchMove/TouchUp sequence.
	 * @param x x-coordinate of the tap, in component coords
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void tap(int x, Map<String, String> mods);
	/**
	 * Taps on the component. On Android, plays a 'click'. On iOS, plays a TouchDown/TouchMove/TouchUp sequence.
	 * @param x x-coordinate of the tap, in component coords
	 * @param y y-coordinate of the tap, in component coords
	 */
	 ...
	 * @param mods the MonkeyTalk modifiers
	 */
	public void tap(int x, int y, Map<String, String> mods);
