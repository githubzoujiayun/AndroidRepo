...
public enum MonkeyTalkImagesEnum {
    ...
    MONKEYTALK_TINY("icons/mt-icon-16.png"),
    MONKEYTALK_LARGE("icons/mt-icon-128.png"),
    ...
    TIME("icons/coolbaricons/clock.png"),
    SCREENSHOT("icons/coolbaricons/camera.png"),
    BROWSE("icons/browse.png"),
    SCREENSHOTERROR("icons/coolbaricons/camera_delete.png"),
    //
    REFRESHNAVENABLED("icons/refresh_nav_enabled.gif"),
    REFRESHNAVDISABLED("icons/refresh_nav_disabled.gif"),
    GLICON("icons/gl-icon-16.png"),
    ICONEDIT("icons/edit.png"),
    PROJECTFOLDER("icons/project-folder.png"),
    
    APPCHOICE("icons/mt-icon-16.png");
