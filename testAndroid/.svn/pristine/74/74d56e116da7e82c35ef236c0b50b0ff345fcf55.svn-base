...
public class ReportTest extends TestHelper {
	...
	public void testHTMLReport() throws InterruptedException {
		...
		assertThat(html, containsString("www.cloudmonkeymobile.com"));
	}
	...
	@Test
	public void testHTMLReportWithDeeplyNestedSuites() throws InterruptedException {

		Suite s1 = new Suite("booSS");
		Suite s2 = new Suite("cooSS");
		Suite s3 = new Suite("dooSS");
		Suite s4 = new Suite("fooSS");
		Suite s5 = new Suite("gooSS");
		Suite s6 = new Suite("hooSS");

		Suite first = new Suite("first");
		...
		Report r = new Report(first);

		String html = r.getMainSuite().toHTML();
		assertThat(html, containsString("<!doctype html>"));
		assertThat(html, containsString("<li id=\"suite-name\">first</li>"));
		assertThat(
				html,
				containsString("<li id=\"suite-tests\" class=\"suite-tests\" data-tests=\"6\" data-err=\"0\" data-fail=\"0\" data-skip=\"0\"></li>"));
		assertThat(html, containsString("<li id=\"suite-name\">booSS</li>"));
		assertThat(
				html,
				containsString("<li id=\"suite-tests\" class=\"suite-tests\" data-tests=\"5\" data-err=\"0\" data-fail=\"0\" data-skip=\"0\"></li>"));
		assertThat(html, containsString("<li id=\"suite-name\">cooSS</li>"));
		assertThat(
				html,
				containsString("<li id=\"suite-tests\" class=\"suite-tests\" data-tests=\"5\" data-err=\"0\" data-fail=\"0\" data-skip=\"0\"></li>"));
		assertThat(html, containsString("<li id=\"suite-name\">dooSS</li>"));
		assertThat(
				html,
				containsString("<li id=\"suite-tests\" class=\"suite-tests\" data-tests=\"5\" data-err=\"0\" data-fail=\"0\" data-skip=\"0\"></li>"));
		assertThat(
				html,
				containsString("<a id=\"link1\" href=\"javascript:tog('1');\" class=\"closed\">baz</a>"));
		assertThat(html, containsString("<li id=\"suite-name\">fooSS</li>"));
		assertThat(
				html,
				containsString("<li id=\"suite-tests\" class=\"suite-tests\" data-tests=\"4\" data-err=\"0\" data-fail=\"0\" data-skip=\"0\"></li>"));
		assertThat(html, containsString("<li id=\"suite-name\">gooSS</li>"));
		assertThat(
				html,
				containsString("<li id=\"suite-tests\" class=\"suite-tests\" data-tests=\"2\" data-err=\"0\" data-fail=\"0\" data-skip=\"0\"></li>"));
		assertThat(html, containsString("<li id=\"suite-name\">hooSS</li>"));
		assertThat(
				html,
				containsString("<li id=\"suite-tests\" class=\"suite-tests\" data-tests=\"1\" data-err=\"0\" data-fail=\"0\" data-skip=\"0\"></li>"));
	}
	...
	public void testSaveReportWithUTF8() throws IOException, InterruptedException {
		...
		assertThat(
				xml,
				containsString("<testcase name=\"foo.mt[H&#233;&#236;&#237;&#244; &#8656;&#8657;&#8669;&#8668;]\""));
