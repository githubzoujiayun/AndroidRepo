...
@class MTContextFilterLogFormatter;
 ...
 * These come from the underlying logging macros defined in MTDDLog.h.
...
**/
@interface MTContextWhitelistFilterLogFormatter : NSObject <MTDDLogFormatter>
...
**/
@interface MTContextBlacklistFilterLogFormatter : NSObject <MTDDLogFormatter>
