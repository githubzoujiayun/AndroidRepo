...
public class ModsTest extends TestHelper {
	...
	public void testModsStaticHelpers() {
		Map<String, String> mods = Mods.of(Mods.THINKTIME, "123");

		assertThat(mods.size(), is(1));
		assertThat(mods.get("thinktime"), is("123"));

		mods = Mods.of(Mods.THINKTIME, "123", Mods.TIMEOUT, "456", Mods.IGNORE, "true");
		...
		mods = Mods.of(Mods.THINKTIME, "123", Mods.TIMEOUT, "456", Mods.IGNORE, "true",
				Mods.SCREENSHOT_ON_ERROR, "false", Mods.SHOULD_FAIL, "true");
	...
	@Test
	public void testModsVarargs() {
		Map<String, String> mods = Mods.of("thinktime", "123", "timeout", "456", "ignore", "true",
				"screenshotonerror", "false", "shouldfail", "true", "fred", "joe");

		assertThat(mods.size(), is(6));
		assertThat(mods.get("thinktime"), is("123"));
		assertThat(mods.get("timeout"), is("456"));
		assertThat(mods.get("ignore"), is("true"));
		assertThat(mods.get("screenshotonerror"), is("false"));
		assertThat(mods.get("shouldfail"), is("true"));
		assertThat(mods.get("fred"), is("joe"));
		assertThat(mods.get("missing"), nullValue());
	}
}
