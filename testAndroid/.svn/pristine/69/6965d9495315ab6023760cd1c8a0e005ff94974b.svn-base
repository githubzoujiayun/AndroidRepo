...
public class ModifiersTest extends BaseCommandTest {
	...
	@Test
	public void testGetScreenshotOnErrorObject() {
		Command cmd = new Command("Button OK Click");
		assertThat(cmd.getScreenshotOnError(), is(nullValue()));
		
		cmd = new Command("Button OK Click %screenshotonerror=false");
		assertThat(cmd.getScreenshotOnError(), is(false));
		
		cmd = new Command("Button OK Click %screenshotonerror=true");
		assertThat(cmd.getScreenshotOnError(), is(true));
		
		cmd = new Command("Button OK Click %screenshotonerror");
		assertThat(cmd.getScreenshotOnError(), is(true));
		
		cmd = new Command("Button OK Click %screenshotonerror=unknown");
		assertThat(cmd.getScreenshotOnError(), is(true));
	}
