...
public class SetterTest extends BaseCommandTest {
	...
	public void testSetArgsAndModifiers() {
		...
		cmd.setArgsAndModifiers("19 %goo=xxx");
		assertThat(cmd.getCommand(), is("Button OK Click 19 %goo=xxx"));
		assertThat(cmd.getArgs(), hasItems("19"));
		assertThat(cmd.getArgsAsString(), is("19"));
		assertThat(cmd.getModifiers().values(), hasItems("xxx"));
		assertThat(cmd.getModifiers().keySet(), hasItems("goo"));
		assertThat(cmd.getModifiersAsString(), is("%goo=xxx"));
		assertCommand(cmd);
		...
		cmd.setArgsAndModifiers("17 %foo=123");
		assertThat(cmd.getCommand(), is("Button OK Click 17 %foo=123"));
		assertThat(cmd.getArgs(), hasItems("17"));
		assertThat(cmd.getArgsAsString(), is("17"));
		assertThat(cmd.getModifiers().values(), hasItems("123"));
		assertThat(cmd.getModifiers().keySet(), hasItems("foo"));
		assertThat(cmd.getModifiersAsString(), is("%foo=123"));
		assertCommand(cmd);
