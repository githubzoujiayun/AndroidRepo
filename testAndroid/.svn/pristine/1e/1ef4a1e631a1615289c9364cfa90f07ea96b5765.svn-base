...
public class CommandTest extends BaseCommandTest {
	...
	public void testSetArgs() {
		...
		args.add("1,2,3");
		args.add("4, 5, 6");
		args.add("notLongForThisWorld");
		cmd.setArgs(args);
		
		assertThat(cmd.getCommand(), is("Button OK Click testing 1,2,3 \"4, 5, 6\" notLongForThisWorld"));
		assertCommand(cmd);
		assertThat(cmd.getArgs().size(), is(4));
		assertThat(cmd.getArgs(), hasItems("testing", "1,2,3", "4, 5, 6", "notLongForThisWorld"));
		assertThat(cmd.getArgsAsString(), is("testing 1,2,3 \"4, 5, 6\" notLongForThisWorld"));
		assertNoModifiers(cmd);
		...
		assertThat(cmd.getCommand(), is("Button OK Click arg1 arg2"));
		assertCommand(cmd);
		assertThat(cmd.getArgs().size(), is(2));
		assertThat(cmd.getArgs(), hasItems("arg1","arg2"));
		assertThat(cmd.getArgsAsString(), is("arg1 arg2"));
