...
public class TestPerspective implements IPerspectiveFactory {
	...
	public static String NEW_WIZARD_CLASS_NAME = "com.gorillalogic.monkeyconsole.wizard.NewProjectWizard";
	...
	public void createInitialLayout(IPageLayout layout) {
       ...
       // IFolderLayout topLeft = layout.createFolder("topLeft", IPageLayout.LEFT, 0.25f,editorArea);
        ...
        layout.addNewWizardShortcut(getNewProjectWizardName());
	...
	private String getNewProjectWizardName(){
		return NEW_WIZARD_CLASS_NAME;
	}
	
	public static void setNewProjectWizardName(String wizardClass){
		NEW_WIZARD_CLASS_NAME = wizardClass;
	}
}