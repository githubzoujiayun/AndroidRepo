...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		store.setDefault(PreferenceConstants.P_ANDROIDHOME, "");
		...
		store.setDefault(PreferenceConstants.P_TAKEAFTERMETRICS, false);
		store.setDefault(PreferenceConstants.P_TAKEERRORSCREENSHOTS, true);
		store.setDefault(PreferenceConstants.P_THINKTIME, "500");
		store.setDefault(PreferenceConstants.P_COMPONENTTREETIMEOUT, "60000");
		store.setDefault(PreferenceConstants.P_EVENTSTOFILTER, "touchdown, touchmove, touchup");
		store.setDefault(PreferenceConstants.P_DUPLICATEEVENTSSUPRESS, "itemselector.select");
		...
		store.setDefault(PreferenceConstants.P_USE_PROXY, false);
		store.setDefault(PreferenceConstants.P_PROXY_HOST, "");
		store.setDefault(PreferenceConstants.P_PROXY_PORT, "");
		store.setDefault(PreferenceConstants.P_USE_PROXY_AUTHENTICATION, false);
		store.setDefault(PreferenceConstants.P_PROXY_USERNAME, "");
		store.setDefault(PreferenceConstants.P_PROXY_PASSWORD, "");
		store.setDefault(PreferenceConstants.P_RECORD_MOVE, false);
		store.setDefault(PreferenceConstants.P_RECORD_SWIPE, true);
		store.setDefault(PreferenceConstants.P_RECORD_DRAG, false);
		store.setDefault(PreferenceConstants.P_RECORD_TAP_COORDINATES, false);
		store.setDefault(PreferenceConstants.P_ISFIRSTLMSUBMISSION, true);
	}
}