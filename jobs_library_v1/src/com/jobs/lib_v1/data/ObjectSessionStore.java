...
public class ObjectSessionStore {
	...
	// 通用 SESSION 的键名
	public final static String SESSION = "$ObjectSessionStore.SESSION." + UUID.randomUUID().toString() + "$";
	...
	public static Object popObject(String key){
		...
		AppUtil.error("ObjectSessionStore", "session-object-size:" + session.size());
