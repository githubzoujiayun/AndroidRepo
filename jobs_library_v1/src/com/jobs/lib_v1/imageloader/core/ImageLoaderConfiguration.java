 ...
 *******************************************************************************/
package com.jobs.lib_v1.imageloader.core;
...
import com.jobs.lib_v1.imageloader.cache.disc.DiscCacheAware;
import com.jobs.lib_v1.imageloader.cache.disc.impl.UnlimitedDiscCache;
import com.jobs.lib_v1.imageloader.cache.disc.naming.FileNameGenerator;
import com.jobs.lib_v1.imageloader.cache.memory.MemoryCacheAware;
import com.jobs.lib_v1.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.jobs.lib_v1.imageloader.core.assist.MemoryCacheUtil;
import com.jobs.lib_v1.imageloader.core.assist.QueueProcessingType;
import com.jobs.lib_v1.imageloader.core.decode.ImageDecoder;
import com.jobs.lib_v1.imageloader.core.download.ImageDownloader;
import com.jobs.lib_v1.imageloader.core.download.NetworkDeniedImageDownloader;
import com.jobs.lib_v1.imageloader.core.download.SlowNetworkImageDownloader;
import com.jobs.lib_v1.imageloader.core.process.BitmapProcessor;
import com.jobs.lib_v1.imageloader.utils.L;
...
public final class ImageLoaderConfiguration {
	...
	public static class Builder {
		 ...
		 * {@link com.jobs.lib_v1.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.jobs.lib_v1.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.jobs.lib_v1.imageloader.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.jobs.lib_v1.imageloader.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Default value -
		 * {@link com.jobs.lib_v1.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		 ...
		 * Default value -
		 * {@link com.jobs.lib_v1.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.jobs.lib_v1.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Default value - {@link com.jobs.lib_v1.imageloader.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by
		 * {@link com.jobs.lib_v1.imageloader.utils.StorageUtils#getCacheDirectory(Context)
