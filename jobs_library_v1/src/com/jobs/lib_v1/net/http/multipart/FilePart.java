...
public class FilePart extends PartBase {
	 ...
	 * 
	 * @param name the name of the file part
	 * @param fileBytes bytes to post as a file
	 * @param fileName the name local file
	 */
	public FilePart(final String name, final byte[] fileBytes, final String fileName) {
		this(name, new PartSource() {
			@Override
			...
			public String getFileName() {
				return TextUtils.isEmpty(fileName) ? (name + ".dat") : fileName;
			}
