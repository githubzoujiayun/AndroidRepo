...
public abstract class Part {
	 ...
	 * @deprecated
	 */
	protected static final byte[] BOUNDARY_BYTES = BOUNDARY.getBytes();
	...
	protected static final byte[] CRLF_BYTES = CRLF.getBytes();

	/*** Content dispostion characters */
	protected static final String QUOTE = "\"";

	/*** Content dispostion as a byte array */
	protected static final byte[] QUOTE_BYTES = QUOTE.getBytes();

	/*** Extra characters */
	protected static final String EXTRA = "--";

	/*** Extra characters as a byte array */
	protected static final byte[] EXTRA_BYTES = EXTRA.getBytes();

	/*** Content dispostion characters */
	protected static final String CONTENT_DISPOSITION = "Content-Disposition: form-data; name=";

	/*** Content dispostion as a byte array */
	protected static final byte[] CONTENT_DISPOSITION_BYTES = CONTENT_DISPOSITION.getBytes();

	/*** Content type header */
	protected static final String CONTENT_TYPE = "Content-Type: ";

	/*** Content type header as a byte array */
	protected static final byte[] CONTENT_TYPE_BYTES = CONTENT_TYPE.getBytes();

	/*** Content charset */
	protected static final String CHARSET = "; charset=";

	/*** Content charset as a byte array */
	protected static final byte[] CHARSET_BYTES = CHARSET.getBytes();

	/*** Content type header */
	protected static final String CONTENT_TRANSFER_ENCODING = "Content-Transfer-Encoding: ";

	/*** Content type header as a byte array */
	protected static final byte[] CONTENT_TRANSFER_ENCODING_BYTES = CONTENT_TRANSFER_ENCODING.getBytes();
	...
	protected void sendTransferEncodingHeader(OutputStream out) throws IOException {
		...
		if (transferEncoding != null) {
			...
			out.write(transferEncoding.getBytes());
		}
	}
