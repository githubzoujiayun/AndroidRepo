...
public abstract class Node {
	...
	public String toString() {
		return getClass().getSimpleName() + " [mId=" + mId + ", mIdMatches="
				+ mIdMatches + ", mParent=" + "???" + ", mConditionType="
	...
	public static abstract class Event extends Node {
		protected void dispatchPerform(PerformListener listener)
		...
		abstract void perform(Node node, PerformListener listener)
				throws UiObjectNotFoundException;
	}
	...
	public static abstract interface IView {
		...
		public abstract void input(String chars)
				throws UiObjectNotFoundException;
	...
	public static enum Scrollable {
		...
		public static Scrollable toType(String type) {
			...
			if (TextUtils.isEmpty(str))
				throw new IllegalArgumentException(
						"Scrollable must have a value in "
